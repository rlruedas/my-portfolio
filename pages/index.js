...
export default function Home() {
  ...
  return (
    <div  >
      ...
      <main className=" font-body antialiased items-center block overflow-x-hidden" id="mainBody" >
        <section className="flex flex-row w-full py-10 absolute justify-around items-center  top-0 text-grey z-20 ">
          <a href="">
            <p className="text-6xlxl" >&nbsp;</p>
          </a>
          {
            width <= 1280 ?
              <button className="" >
        ...
        <section className="hidden" id="myLinks" >
          <div className="flex flex-col justify-center bg-white w-screen h-screen fixed z-30 " >
        ...
        <section className="flex flex-row w-full h-screen items-center justify-center pb-10" >
          <div className="flex flex-col w-.40 h-screen justify-center items-center ">
            <div>
              <Fade top cascade>
                <p className="lg:text-lg lg:p-2 text-grey ">Hi! I'm</p>
        ...
        <section className="flex flex-col w-full items-center justify-center my-20 text-black " id="Projects">
          <Projects />
        </section>
