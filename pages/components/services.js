...
export default function services() {
    return (
        <div className="flex flex-row justify-start items-center  w-screen h-screen relative " >
            ...
            <p className="text-3xl lg:text-9xl absolute right-0 translate-x-10 hidden lg:block lg:translate-x-72 origin-center transform rotate-90 text-grey font-bold" >My Services</p>
