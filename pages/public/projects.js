...
export default function projects() {
    ...
    function ShowModal() {
        ...
        return (
            <Zoom>
                <div className="flex flex-col w-full h-screen fixed top-0 left-0 bg-peach z-30 justify-center items-center ">
    ...
    return (
        <div className="flex flex-col w-full relative justify-center items-center " >
            ...
            <div className="grid lg:grid-cols-2 xl:grid-cols-3 lg:auto-r gap-8 l w-.70 justify-center items-center pt-10" >
                ...
                <div className="flex flex-col w-full h-96 justify-end items-center border-2 border-solid border-peach group hover:bg-seashell hover:border-0 relative" >
